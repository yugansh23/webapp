pipeline {
	...
	stage ('DAST') {
	  ...
	  stage ('Upload Reports to Defect Dojo') {
			...
			sh 'python3 upload-results.py --host 127.0.0.1:8080 --api_key e05fd25b4b1ebe20750f0269ce4be651c701c2d9 --engagement_id 4 --result_file nikto-output.xml --username yugansh'
